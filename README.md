...
For the AraDiCE dialect evaluation benchmark, clone [al-qasida-custom](https://github.com/omar-kallas/al-qasida-custom) into the repository root:

```bash
git clone https://github.com/omar-kallas/al-qasida-custom
```

## Data: MADAR Parallel Corpus
