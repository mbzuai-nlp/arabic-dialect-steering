...
OUT_DIR="$NEURON_DIR/generation_output/coeff_ablation_allam"
...
run_one() {
  ...
  local label="$5"
  local out_file="$OUT_DIR/allam_${label}_alpha${alpha}.jsonl"

  echo "============================================================"
  echo "ALLaM coefficient ablation: ${label}, alpha=${alpha}"
